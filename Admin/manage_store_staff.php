...
?>
      <script>
        ...
        window.location.href = "store_staff.php";
      </script>
    <?php
    }
  }
...
<section class="admin-right-panel">
  <div class="admin-panel-alert">
    ...
    if ($isValidImage == 0) {
      echo "<div class='bg-warning admin-alert-dismiss-container'>
                    <strong>Warning!</strong> Invalid image format(use jpg/ jpeg/ png), Store staff details update failed
  ...
  <div class="admin-staffs-main">
    <div class="admin-add-container p-2">
      <button class="btn btn-warning btn-lg btn-block m-2">Update Staff Details</button>
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="p-2 admin-add-dorpdown-form" enctype="multipart/form-data">
        ...
        <div class="m-2 update-bottom-menues">
          <button type="button" class="btn btn-danger admin-submit-btn"><a href="store_staff.php" class="text-decoration-none text-white">Cancel</a></button>
